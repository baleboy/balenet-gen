...
Mapbox’s main competitors are Google Maps, HERE, Tomtom and a fork of Mapbox’s own open source version called [MapLibre](https://maplibre.org). For most of its existence Mapbox’s software was open source, but at some point the company decided to move to closed source and that’s when MapLibre was born.
